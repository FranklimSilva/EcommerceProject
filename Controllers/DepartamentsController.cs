        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            catch (System.Exception ex)
            {
                if (ex.InnerException != null && ex.InnerException.InnerException != null && ex.InnerException.InnerException.Message.Contains("REFERENCE")) {
                    ModelState.AddModelError(string.Empty, "Não é possivel remover o departamento, porque existe cidades relacionadas a ele! Primeiro remova as cidades e volte a tentar!");
                }
                else
                {
                    ModelState.AddModelError(string.Empty, ex.Message);
